...
-- First, let's create shelter owners with different UUIDs
INSERT INTO users (id, email, full_name, role)
VALUES 
  ('830fcd68-3052-43de-bf16-1dd0f28aa6bf', 'shelter1@example.com', 'Happy Paws Shelter', 'shelter'),
  ('a40fcd68-3052-43de-bf16-1dd0f28aa6bf', 'shelter2@example.com', 'Pet Paradise', 'shelter')
ON CONFLICT (id) DO NOTHING;

-- Add more diverse pets
INSERT INTO pets (
  id, name, species, breed, age, gender, size, 
  description, status, images, location_address, owner_id
) VALUES 
  (
    gen_random_uuid(),
    'Charlie',
    ...
    'Los Angeles, CA',
    '830fcd68-3052-43de-bf16-1dd0f28aa6bf'
  ),
  (
    gen_random_uuid(),
    'Mittens',
  ...
  (
    ...
    'Austin, TX',
    'a40fcd68-3052-43de-bf16-1dd0f28aa6bf'
  ),
  (
    gen_random_uuid(),
    'Whiskers',
